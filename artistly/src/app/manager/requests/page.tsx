  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <p className="text-gray-700 mb-4">All your booking requests will appear here. (Feature coming soon!)</p>
        <table className="min-w-full bg-white rounded shadow mt-4">
          <thead>
            <tr className="bg-blue-50">
              <th className="py-2 px-4 text-left font-semibold">Request ID</th>
          ...
          <tbody>
            <tr>
              <td className="py-2 px-4 text-gray-400" colSpan={4}>No requests yet.</td>
            </tr>
          </tbody>
        </table>
      </div>
